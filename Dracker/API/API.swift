...
func fetch_data(user_id: String, completion: @escaping () -> Void) {
    make_api_call(parameters: [:], api_endpoint: nil, method: .get, custom_endpoint: Endpoints.base.rawValue + "/users/\(user_id)") { (data) in
        if data.isFailure {
            completion()
            return
        }
...
func fetch_friends(user_id: String, completion: @escaping () -> Void) {
    make_api_call(parameters: [:], api_endpoint: nil, method: .get, custom_endpoint: Endpoints.friends.rawValue + "/\(user_id)") { (data) in
        if data.isFailure {
            completion()
            return
        }
...
func get_user_data(phone: String, completion: @escaping ((Result<Any>) -> Void)) {
    make_api_call(parameters: ["phone": phone], api_endpoint: .user_data, method: .get, custom_endpoint: nil, completion: completion)
}

func post_delete_transaction(parameters: [String: String], completion: ((Result<Any>) -> Void)? = nil) {
    make_api_call(parameters: parameters, api_endpoint: .delete_transaction, method: .get, custom_endpoint: nil, completion: completion)
}

func post_settle_transaction(parameters: [String: String], completion: ((Result<Any>) -> Void)? = nil) {
    make_api_call(parameters: parameters, api_endpoint: .settle_transaction, method: .get, custom_endpoint: nil, completion: completion)
}

func update_email(parameters: [String: String], completion: @escaping ((Result<Any>) -> Void)) {
    make_api_call(parameters: parameters, api_endpoint: .update_email, method: .put, custom_endpoint: nil, completion: completion)
}

func put_transaction(parameters: [String: String], completion: @escaping ((Result<Any>) -> Void))
{
    make_api_call(parameters: parameters, api_endpoint: .add_transaction, method: .put, custom_endpoint: nil, completion: completion)
}

//Get list of users
func get_users(completion: ((Result<Any>) -> Void)? = nil) {
    make_api_call(parameters: [:], api_endpoint: .users_list, method: .get, custom_endpoint: nil, completion: completion)
}
...
func create_user(phone: String, password: String, email: String, name: String, completion: ((Result<Any>) -> Void)? = nil) {
    ...
    make_api_call(parameters: parameters, api_endpoint: .add_user, method: .put, custom_endpoint: nil, completion: completion)
}

func get_transaction(parameter: [String: String], completion: ((Result<Any>) -> Void)? = nil) {
    make_api_call(parameters: parameter, api_endpoint: .get_transaction, method: .get, custom_endpoint: nil, completion: completion)
}

fileprivate func make_api_call(parameters: [String: String], api_endpoint: Endpoints?, method: HTTPMethod, custom_endpoint: String? = nil, completion: ((Result<Any>) -> Void)? = nil) {
    let headers = ["x-api-key" : Dracker_API_KEY]
    let endpoint = custom_endpoint == nil ? api_endpoint?.rawValue: custom_endpoint
