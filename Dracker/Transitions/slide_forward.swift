...
/**
 ...
 another in simultaneously in forward direction.
 */
class slide_forward: NSObject,UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        //Animate
        UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 5, initialSpringVelocity: 1, options: .curveEaseIn, animations: {
